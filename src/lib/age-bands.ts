...
export const AGE_BANDS = [
  { slug: "2-4", key: "2-4", min: 2, max: 4 },
  { slug: "5-7", key: "5-7", min: 5, max: 7 },
  { slug: "8-10", key: "8-10", min: 8, max: 10 },
  { slug: "11-12", key: "11-12", min: 11, max: 12 },
  { slug: "13-15", key: "13-15", min: 13, max: 15 },
  { slug: "16-plus", key: "16+", min: 16, max: 18 },
] as const
 ...
 *  and a vote floor to keep obscure noise off a browse surface. */
export function ageBandCatalogWhere(min: number, max: number): Prisma.MediaItemWhereInput {
  return {
