...
const collections: Collection[] = [
  {
    ...
    href: "/films/recherche?genres=Aventure",
  },
  {
    id: "animals",
    ...
    href: "/films/recherche?topics=Animaux,Nature",
  },
  {
    id: "comedy",
    title: "Comedies",
    ...
    href: "/films/recherche?genres=Comedie",
  },
  {
    id: "fantasy",
    title: "Fantastique",
    ...
    href: "/films/recherche?genres=Fantastique",
  },
  {
    id: "music",
    title: "Musique & Danse",
    description: "Comedies musicales et films musicaux",
    icon: Music,
    color: "text-emerald-600",
    bgGradient: "from-emerald-100 to-teal-100",
    href: "/films/recherche?genres=Musique",
  },
  {
    id: "scifi",
    ...
    href: "/films/recherche?genres=Science-Fiction",
  },
  {
    id: "family",
    title: "Drame & Famille",
    description: "Histoires emouvantes pour toute la famille",
    icon: Heart,
    color: "text-red-500",
    bgGradient: "from-red-100 to-pink-100",
    href: "/films/recherche?genres=Drame,Famille",
  },
  {
    id: "animation",
    title: "Animation",
    description: "Dessins animes et films d'animation",
    icon: BookOpen,
    color: "text-teal-600",
    bgGradient: "from-teal-100 to-cyan-100",
    href: "/films/recherche?genres=Animation",
  },
]
