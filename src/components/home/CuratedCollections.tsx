...
const collections: Collection[] = [
  {
    ...
    href: "/films?topics=Aventure,Voyage",
  },
  {
    id: "animals",
    ...
    href: "/films?topics=Animaux,Nature",
  },
  {
    id: "comedy",
    ...
    href: "/films?genres=Comedie&maxAge=12",
  },
  {
    id: "fantasy",
    title: "Magie & Fantaisie",
    description: "Mondes enchantes et creatures magiques",
    icon: Wand2,
    color: "text-purple-600",
    bgGradient: "from-purple-100 to-violet-100",
    href: "/films?genres=Fantastique,Animation",
  },
  {
    id: "music",
    title: "Musique & Danse",
  ...
  },
  {
    ...
    href: "/films?genres=Science-Fiction",
  },
  {
    id: "family",
    title: "Valeurs Familiales",
    description: "Amitie, courage et entraide",
    icon: Heart,
    color: "text-red-500",
    bgGradient: "from-red-100 to-pink-100",
    href: "/films?topics=Famille,Amitie",
  },
  {
    id: "learning",
    title: "Educatif & Culture",
    description: "Apprendre en s'amusant",
    icon: BookOpen,
    color: "text-teal-600",
    bgGradient: "from-teal-100 to-cyan-100",
    href: "/films?topics=Education,Histoire",
  },
]
