...
export const metadata: Metadata = {
  ...
  description: "Découvrez nos collections thématiques : les meilleurs films, séries et jeux pour enfants et ados, réunis en sélections avec un âge conseillé pour chaque titre.",
