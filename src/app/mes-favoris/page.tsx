...
export default function MesFavorisPage() {
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      try {
        ...
        const mapped = (data.favorites as ApiItem[])
  ...
  if (!session?.user) {
    redirect("/connexion?callbackUrl=/mes-favoris")
  }
        ...
        >
          <div className="container mx-auto px-4 md:px-8">
            ...
            <p className="mt-3 text-sm md:text-base" style={{ color: p.ink2 }}>
              Les films, séries et jeux que vous avez marqués comme favoris.
            </p>
          </div>
        </section>
            ...
            {loading ? (
              ...
              >
                ...
                <p className="text-sm mb-6" style={{ color: p.ink2 }}>
                  Parcourez le catalogue et ajoutez vos coups de cœur.
                </p>
                <Link
                  href="/films"
