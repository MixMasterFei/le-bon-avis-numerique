...
Concrètement, il s'agit de courtes sessions menées en classe, sous la surveillance d'un enseignant, autour de deux thèmes : comment fonctionne l'IA générative, et comment s'en servir de façon éclairée. L'esprit n'est pas de dire aux élèves « n'utilisez jamais l'IA », mais de leur apprendre à en comprendre les limites, à protéger leurs données et à garder un regard critique.
